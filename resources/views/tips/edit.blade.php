 ...
 <div class="container-fluid" id="container-wrapper">
   ...
   <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Tips</h1>
            <ol class="breadcrumb">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tips_title" id="tips_title" aria-describedby="tips_title"
                          placeholder="Tips Title" value="{{old('tips_title',$tip->tips_title)}}" required="">
                       @error('tips_title') 
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="league_name" id="league_name" aria-describedby="league_name"
                        placeholder="League name" value="{{old('league_name',$tip->league_name)}}" required="">
                     @error('league_name') 
                       <p class="alert alert-danger">{{ $message }}</p>
                     @enderror
                    </div>
                      ...
                      <div class="form-group">
                       ...
                       <select class="select2-single form-control" id="status" name="status" required="">
                        <option value="" selected="" disabled="">Select Status</option>
                         ...
                         <option value="Win" <?php if($tip->status == 'Win'){echo "selected";} ?>>Win</option>
                         <option value="Loss" <?php if($tip->status == 'Loss'){echo "selected";} ?>>Loss</option>
                       </select>
                       @error('status')
                         <p class="alert alert-danger">{{ $message }}</p>
                       @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="team_one" id="team_one" aria-describedby="team_one"
                          placeholder="Team one" value="{{old('team_one',$tip->team_one)}}" required="">
                       @error('team_one') 
                         <p class="alert alert-danger">{{ $message }}</p>
                       @enderror
                      </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="team_two" id="team_two" aria-describedby="team_two"
                          placeholder="Team two" value="{{old('team_two',$tip->team_two)}}" required="">
                       @error('team_two') 
                         <p class="alert alert-danger">{{ $message }}</p>
                       @enderror
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="datetime-local" name="date_time" class="form-control" id="date_time" value="{{$tip->date_time}}" required="">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="odds_value" class="form-control" id="odds_value" placeholder="Odds Value" value="{{old('odds_value',$tip->odds_value)}}" required="">
                        @error('odds_value') 
                         <p class="alert alert-danger">{{ $message }}</p>
                       @enderror
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="team_one_score" class="form-control" id="team_one_score" placeholder="Team one score" value="{{old('team_one_score',$tip->team_one_score)}}" required=""> 
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="team_two_score" class="form-control" id="team_two_score" placeholder="Team two score" value="{{old('team_two_score',$tip->team_two_score)}}" required=""> 
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input name="team_one_image" type="file" id="team_one_image" accept="image/*" class="dropify" data-height="150" data-default-file="{{URL::to($tip->team_one_image)}}" />
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input name="team_two_image" type="file" id="team_two_image" accept="image/*" class="dropify" data-height="150" data-default-file="{{URL::to($tip->team_two_image)}}" />
